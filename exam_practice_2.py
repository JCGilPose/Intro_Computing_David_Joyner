...
def joynernacci(an_index):
    if an_index == 1 or an_index == 2:
        return 1

    elif an_index % 2 == 1:
        return abs(joynernacci(an_index-1) - joynernacci(an_index-2)) 
    else:
        return joynernacci(an_index-1) + joynernacci(an_index-2)
