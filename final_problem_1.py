...
def to_dictionaries(nations):
    ...
    for nation in nations:
        data = {}
        data["long_name"] = nation.long_name
        data["iso_code"] = nation.iso_code
        data["iso_short"] = nation.iso_short
        data["iso_long"] = nation.iso_long
        data["capital"] = nation.capital
        dictionary[nation.short_name] = data
    return dictionary
