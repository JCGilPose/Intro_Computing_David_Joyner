...
def binary_search_year(dates_list, search_year):
    dates_list.sort()
    ...
    if dates_list[middle].year == search_year:
        return True
    elif search_year < dates_list[middle].year:
        return binary_search_year(dates_list[:middle], search_year)
    else:
        return binary_search_year(dates_list[middle + 1:], search_year)
